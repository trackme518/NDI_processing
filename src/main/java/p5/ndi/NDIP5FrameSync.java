...
public class NDIP5FrameSync extends NDIP5FrameCleaner implements AutoCloseable {
     ...
     */
    public NDIP5FrameSync(NDIP5Receiver receiver) {
     ...
     * {@code NDIP5Framesync#captureAudio(audioFrame, 0, 0, 0);}
     ...
     */
    public void captureAudio(NDIP5AudioFrame audioFrame, int sampleRate, int channelCount, int sampleCount) {
     ...
     *
     * The {@link NDIP5FrameFormatType} can be specified, which is then used to return the best possible frame.
     ...
     */
    public boolean captureVideo(NDIP5VideoFrame videoFrame, NDIP5FrameFormatType formatType) {
     ...
     * This function will always return immediately, using time-base correction if needed.
     *
     * This function will get frames formatted as {@link NDIP5FrameFormatType#PROGRESSIVE}
     * Note: The same frame can be returned multiple times.
     *
     * If no video frames have been received, this will return false, and have a {@code null} video data.
     *
     ...
     * @return Whether a video frame has been received.
     */
    public boolean captureVideo(NDIP5VideoFrame videoFrame) {
        return captureVideo(videoFrame, NDIP5FrameFormatType.PROGRESSIVE);
    }
