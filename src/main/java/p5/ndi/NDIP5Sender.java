 ...
 */
public class NDIP5Sender extends NDIP5FrameCleaner implements AutoCloseable {
     ...
     * @param groups The groups this source should be a part of, or {@code null} for default.
     */
    public NDIP5Sender(String ndiName, String groups) {
     ...
     * @param ndiName The name of the NDI source to create, or {@code null} to auto-generate.
     */
    public NDIP5Sender(String ndiName) {
     ...
     */
    public void sendVideoFrame(NDIP5VideoFrame frame) {
     ...
     *
     * The given {@link NDIP5VideoFrame} cannot be freed or re-used until a synchronizing event has occurred.
     * Synchronizing events are :
     *  - a {@link NDIP5Sender#sendVideoFrame(NDIP5VideoFrame)} call
     *  - a {@link NDIP5Sender#sendVideoFrameAsync(NDIP5VideoFrame)} call with another frame to send
     *  - a {@link NDIP5Sender#sendVideoFrameAsync(NDIP5VideoFrame)} call with {@code null}
     *  - a {@link NDIP5Sender#close()} call
     *
     ...
     */
    public void sendVideoFrameAsync(NDIP5VideoFrame frame) {
     ...
     */
    public void sendAudioFrame(NDIP5AudioFrame frame) {
     ...
     * @param frame A filled audio frame to send.
     */
    public void sendAudioFrameInterleaved16s(NDIP5AudioFrameInterleaved16s frame) {
     ...
     * @param frame A filled audio frame to send.
     */
    public void sendAudioFrameInterleaved32s(NDIP5AudioFrameInterleaved32s frame) {
     ...
     * @param frame A filled audio frame to send.
     */
    public void sendAudioFrameInterleaved32f(NDIP5AudioFrameInterleaved32f frame) {
     ...
     */
    public void sendMetadataFrame(NDIP5MetadataFrame frame) {
     ...
     *
     * Frames that are filled with data MUST be later cleared, with calling {@link NDIP5MetadataFrame#freeBuffer()}, {@link NDIP5MetadataFrame#close}, or with a try-with-resources.
     *
     ...
     * @return {@link NDIP5FrameType#METADATA} if a frame was captured, or {@link NDIP5FrameType#NONE} otherwise.
     */
    public NDIP5FrameType sendCapture(NDIP5MetadataFrame metadataFrame, int timeout) {
        ...
        NDIP5FrameType frameType = NDIP5FrameType.valueOf(type);
        if (frameType == NDIP5FrameType.METADATA && metadataFrame != null) {
     ...
     */
    public NDIP5Tally getTally(int timeoutMs) {
        byte tallyResult = getTally(ndilibSendInstancePointer, timeoutMs);
        if(tallyResult == (byte)-1) {
            return null;
        } else {
            return new NDIP5Tally((tallyResult & 1) == 1, ((tallyResult & 0xFF) & (1 << 1)) == (1 << 1));
        }
    }
     ...
     */
    public void addConnectionMetadata(NDIP5MetadataFrame frame) {
     ...
     */
    public void setFailoverSource(NDIP5Source source) {
        setFailover(ndilibSendInstancePointer, source == null ? 0 : source.structPointer);
    }

    /**
     * Creates a COPY of the {@link NDIP5Source} struct for this sender.
     *
     * @return A copy of the {@link NDIP5Source} this sender is for.
     */
    public NDIP5Source getSource() {
        return new NDIP5Source(getSource(ndilibSendInstancePointer));
    }
    ...
    @Override
    void freeVideo(NDIP5VideoFrame videoFrame) {
        throw new UnsupportedOperationException("Cannot free NDIP5VideoFrame using NDIP5Sender. This should be unreachable, please open an issue at https://github.com/WalkerKnapp/devolay/issues.");
    }

    @Override
    void freeAudio(NDIP5AudioFrame audioFrame) {
        throw new UnsupportedOperationException("Cannot free NDIP5AudioFrame using NDIP5Sender. This should be unreachable, please open an issue at https://github.com/WalkerKnapp/devolay/issues.");
    }

    @Override
    void freeMetadata(NDIP5MetadataFrame metadataFrame) {
