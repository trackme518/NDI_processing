...
public enum NDIP5FrameType {
     ...
     * This will be returned from {@link NDIP5Receiver#receiveCapture} when a device is known
    ...
    NDIP5FrameType(int id) {
        this.id = id;
    }

    /**
     * Queries the {@link NDIP5FrameType} based on an internal ID.
     ...
     */
    public static NDIP5FrameType valueOf(int id) {
        switch (id) {
            case 0: return NONE;
            case 1: return VIDEO;
            case 2: return AUDIO;
