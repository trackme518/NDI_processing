 ...
 */
public class NDIP5AudioFrame implements AutoCloseable {
     ...
     *
     * Most audio will consist of interleaved data, so should use {@link NDIP5Utilities#interleavedFloatToPlanarFloat(NDIP5AudioFrameInterleaved32f, NDIP5AudioFrame)} interleavedFloatToPlanarFloat}
     * before setting.
     *
