 ...
 */
public class NDIP5Router implements AutoCloseable {
    /**
     ...
     * @param ndiName The name of the routed NDI source to create, or {@code null} to auto-generate.
     */
    public NDIP5Router(String ndiName) {
        this(ndiName, null);
    }
     ...
     *
     * @param source A source given by a {@link NDIP5Finder} instance. This must not be {@code null}: instead, call {@link #clearSource()}.
     */
    public void setSource(NDIP5Source source) {
     ...
     * The {@link NDIP5Source} instance created with this method is valid until {@link #close()} is called.
     *
     * @return A {@link NDIP5Source} instance with information about the current source, or null if this source is disconnected.
     */
    public NDIP5Source getSource() {
        long sourcePointer = routingSource(this.ndiLibRoutingInstancePointer);
        if (sourcePointer != 0L) {
            return new NDIP5Source(sourcePointer);
        } else {
            return null;
        }
    }
