...
public class NDIP5Source implements AutoCloseable {
    ...
    public String getSourceName() {
        if(isClosed.get()) {
            throw new IllegalStateException("Cannot access attribute of closed NDIP5Source. Please read the javadocs for NDIP5Finder#getCurrentSources");
        }
