...
#include "ndi_stream_NDIFrameSync.h"

JNIEXPORT jlong JNICALL Java_ndi_stream_NDIFrameSync_framesyncCreate(JNIEnv *env, jclass jClazz, jlong pReceiver) {
    return (jlong) getNDILib()->framesync_create(reinterpret_cast<NDIlib_recv_instance_t>(pReceiver));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDIFrameSync_framesyncDestroy(JNIEnv *env, jclass jClazz, jlong pFramesync) {
    getNDILib()->framesync_destroy(reinterpret_cast<NDIlib_framesync_instance_t>(pFramesync));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDIFrameSync_framesyncCaptureAudio
...
/*JNIEXPORT jint Java_ndi_stream_NDIFrameSync_framesyncAudioQueueDepth
...
JNIEXPORT void JNICALL Java_ndi_stream_NDIFrameSync_framesyncFreeAudio
...
JNIEXPORT jboolean JNICALL Java_ndi_stream_NDIFrameSync_framesyncCaptureVideo
...
JNIEXPORT void JNICALL Java_ndi_stream_NDIFrameSync_framesyncFreeVideo
        (JNIEnv *env, jclass jClazz, jlong pFramesync, jlong pFrame) {
