...
#include "ndi_stream_NDISender.h"
...
JNIEXPORT jlong JNICALL Java_ndi_stream_NDISender_sendCreate(JNIEnv *env, jclass jClazz, jstring jNdiName, jstring jGroups, jboolean jClockVideo, jboolean jClockAudio) {
...
JNIEXPORT jlong JNICALL Java_ndi_stream_NDISender_sendCreateDefaultSettings(JNIEnv *env, jclass jClazz) {
    NDIlib_send_create_t NDI_send_create_desc;

    return reinterpret_cast<jlong>(getNDILib()->send_create(&NDI_send_create_desc));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendDestroy(JNIEnv *env, jclass jClazz, jlong pSender) {
    getNDILib()->send_destroy(reinterpret_cast<NDIlib_send_instance_t>(pSender));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendVideoV2(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendVideoAsyncV2(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
    getNDILib()->send_send_video_async_v2(reinterpret_cast<NDIlib_send_instance_t>(pSender),
                                      reinterpret_cast<const NDIlib_video_frame_v2_t *>(pFrame));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendAudioV2(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendAudioInterleaved16s(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendAudioInterleaved32s(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendAudioInterleaved32f(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_sendMetadata(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
...
JNIEXPORT jbyte JNICALL Java_ndi_stream_NDISender_getTally(JNIEnv *env, jclass jClazz, jlong pSender, jint jTimeoutMs) {
    return 0;
}

JNIEXPORT jint JNICALL Java_ndi_stream_NDISender_getNoConnections(JNIEnv *env, jclass jClazz, jlong pSender, jint jTimeoutMs) {
    return getNDILib()->send_get_no_connections(reinterpret_cast<NDIlib_send_instance_t>(pSender), jTimeoutMs);
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_clearConnectionMetadata(JNIEnv *env, jclass jClazz, jlong pSender) {
    getNDILib()->send_clear_connection_metadata(reinterpret_cast<NDIlib_send_instance_t>(pSender));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_addConnectionMetadata(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFrame) {
    getNDILib()->send_add_connection_metadata(reinterpret_cast<NDIlib_send_instance_t>(pSender),
                                                reinterpret_cast<const NDIlib_metadata_frame_t *>(pFrame));
}

JNIEXPORT void JNICALL Java_ndi_stream_NDISender_setFailover(JNIEnv *env, jclass jClazz, jlong pSender, jlong pFailoverSource) {
...
JNIEXPORT jlong JNICALL Java_ndi_stream_NDISender_getSource(JNIEnv *env, jclass jClazz, jlong pSender) {
    return (jlong) getNDILib()->send_get_source_name(reinterpret_cast<NDIlib_send_instance_t>(pSender));
}

JNIEXPORT jint JNICALL Java_ndi_stream_NDISender_sendCapture(JNIEnv *env, jclass jClazz, jlong pSender, jlong pMetadataFrame, jint jTimeout) {
...
JNIEXPORT void JNICALL Java_ndi_stream_NDISender_freeMetadata(JNIEnv *env, jclass jClazz, jlong pSender, jlong pMetadataFrame) {
