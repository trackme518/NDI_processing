...
//
// Natives inside the jar follow the layout expected by NDIP5.java:
//   natives/<os>/<arch>/<library>   e.g.  natives/macos/arm64-v8a/libndip5-natives.dylib
...
val compileNatives by tasks.registering {
    ...
    doLast {
        ...
        val outName = System.mapLibraryName("ndip5-natives")
        ...
        for (target in hostTargets) {
            ...
            logger.lifecycle("Compiling ndip5-natives for $currentOs/${target.archDir}")
