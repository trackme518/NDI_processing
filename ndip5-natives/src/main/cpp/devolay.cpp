...
JNIEXPORT jint JNICALL Java_p5_ndi_NDIP5_nLoadLibraries(JNIEnv * env, jclass jClazz, jstring jNdiLibraryPath) {
...
JNIEXPORT jstring JNICALL Java_p5_ndi_NDIP5_nGetVersion(JNIEnv *env, jclass jClazz) {
    return env->NewStringUTF(getNDILib()->version());
}

JNIEXPORT jboolean JNICALL Java_p5_ndi_NDIP5_nIsSupportedCpu(JNIEnv *env, jclass jClazz) {
